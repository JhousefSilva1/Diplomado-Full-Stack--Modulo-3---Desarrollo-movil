...
import 'package:smart_puzzle/widgets/letter_puzzle/letter_mini_puzzle_board.dart';

class LetterStepByStepSolutionDialog extends StatefulWidget {
  final int size;
  final List<List<String>> solution;

  const LetterStepByStepSolutionDialog({
    super.key,
    required this.size,
  ...
  @override
  State<LetterStepByStepSolutionDialog> createState() =>
      _LetterStepByStepSolutionDialogState();
}

class _LetterStepByStepSolutionDialogState
    extends State<LetterStepByStepSolutionDialog> {
  int currentPage = 0;
